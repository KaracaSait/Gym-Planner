...
class intermediatemaledao {
    ...
    func veriOkumaA() -> [premade] {
        ...
        do {
            ...
            let rs = try db!.executeQuery("SELECT * FROM intermediatemale WHERE day = 'a'", values: nil)
    ...
    func veriOkumaB() -> [premade] {
        ...
        do {
            ...
            let rs = try db!.executeQuery("SELECT * FROM intermediatemale WHERE day = 'b'", values: nil)
    ...
    func veriOkumaC() -> [premade] {
        ...
        do {
            ...
            let rs = try db!.executeQuery("SELECT * FROM intermediatemale WHERE day = 'c'", values: nil)
    ...
    func veriOkumaD() -> [premade] {
        ...
        do {
            ...
            let rs = try db!.executeQuery("SELECT * FROM intermediatemale WHERE day = 'd'", values: nil)
