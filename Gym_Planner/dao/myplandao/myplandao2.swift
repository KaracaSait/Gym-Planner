...
class myplandao2 {
    ...
    func veriEkle(movement_name:String,set1:String,set2:String) {
        ...
        do {
            try db!.executeUpdate("INSERT INTO myplan2 (myplan_name,myplan_set1,myplan_set2) VALUES (?,?,?)", values: [movement_name,set1,set2])
    ...
    func veriSil(movement_id:Int) {
        ...
        do {
            ...
            try db!.executeUpdate("DELETE FROM myplan2 WHERE myplan_id = ?", values: [movement_id])
