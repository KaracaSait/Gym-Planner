...
class myplandao {
    ...
    func veriEkle(movement_name:String,set1:String,set2:String) {
        ...
        do {
            try db!.executeUpdate("INSERT INTO myplan (myplan_name,myplan_set1,myplan_set2) VALUES (?,?,?)", values: [movement_name,set1,set2])
    ...
    func veriOkuma() -> [Movement] {
        ...
        do {
            ...
            let rs = try db!.executeQuery("SELECT * FROM myplan", values: nil)
    ...
    func veriSil(movement_id:Int) {
        ...
        do {
            ...
            try db!.executeUpdate("DELETE FROM myplan WHERE myplan_id = ?", values: [movement_id])
