...
class bodyweightsizedao {
    ...
    func veriEkle(size_size:String,size_unit:String,size_date:String) {
        ...
        do {
            try db!.executeUpdate("INSERT INTO bodyweightsize (size_size,size_unit,size_date) VALUES (?,?,?)", values: [size_size,size_unit,size_date])
    ...
    func veriOkuma() -> [MeasureSize] {
        ...
        do {
            ...
            let rs = try db!.executeQuery("SELECT * FROM bodyweightsize", values: nil)
    ...
    func veriSil(size_id:Int) {
        ...
        do {
            ...
            try db!.executeUpdate("DELETE FROM bodyweightsize WHERE size_id = ?", values: [size_id])
    ...
    func temizle(){
        ...
        do {
            ...
            try db!.executeUpdate("DELETE FROM bodyweightsize ", values:nil)
