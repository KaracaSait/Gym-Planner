...
class armsizedao {
    ...
    func veriEkle(size_size:String,size_unit:String,size_date:String) {
        ...
        do {
            try db!.executeUpdate("INSERT INTO armsize (size_size,size_unit,size_date) VALUES (?,?,?)", values: [size_size,size_unit,size_date])
    ...
    func veriOkuma() -> [MeasureSize] {
        ...
        do {
            ...
            let rs = try db!.executeQuery("SELECT * FROM armsize", values: nil)
    ...
    func veriSil(size_id:Int) {
        ...
        do {
            ...
            try db!.executeUpdate("DELETE FROM armsize WHERE size_id = ?", values: [size_id])
    ...
    func temizle(){
        ...
        do {
            ...
            try db!.executeUpdate("DELETE FROM armsize ", values:nil)
